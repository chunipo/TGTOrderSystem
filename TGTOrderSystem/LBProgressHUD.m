...
- (void)show:(BOOL)animated
{
    ...
    if (animated)
    {
        self.toast.transform = CGAffineTransformScale(self.transform,0.1,0.1);
        
        [UIView animateWithDuration:0 animations:^{
            self.toast.transform = CGAffineTransformScale(self.transform,1,1);
...
- (void)hide:(BOOL)animated
{
    [UIView animateWithDuration:animated ? 0 : 0 animations:^{
        ...
        [UIView animateWithDuration:animated ? 0 : 0 animations:^{
            self.toast.transform = CGAffineTransformScale(self.transform,0,0);
        } completion:^(BOOL finished) {
